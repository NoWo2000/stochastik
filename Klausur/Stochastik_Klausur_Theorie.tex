...
\end{align*}
$\Rightarrow$ Man nimmt sich aus jedem $P(A \cap B_1)$ bis $P(A \cap B_n)$ einzelne Anteile der Wahrscheinlichkeit von A und summiert sie auf. Die Summe über 1 bis n für stellt dabei sicher das jeder Teil von A berücksichtigt wird, da $\bigcup_{j=1}^{n} B_j = \Omega$ gilt.\\
